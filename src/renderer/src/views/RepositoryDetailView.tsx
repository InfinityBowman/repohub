  ...
  return (
    <div className='-mx-6 -mb-6 flex h-[calc(100%+1.5rem)] flex-col overflow-y-auto'>
            ...
            <div className='min-w-0'>
              <div className='flex items-center gap-2'>
                ...
                {repo.gitBranch && (
                  <Badge
                    variant='outline'
                    className='gap-1 border-blue-800/50 bg-blue-900/20 text-blue-400'
                  >
                ...
                {running && (
                  <Badge
                    variant='outline'
                    className='border-green-800/50 bg-green-900/30 text-green-400'
                  >
      ...
      <div className='flex flex-col gap-6 p-6'>
        {/* Process Section */}
        <section>
          <h2 className='text-muted-foreground mb-3 text-sm font-medium'>Process</h2>
          ...
          : <div className='border-border flex h-32 items-center justify-center rounded-md border bg-[#0a0a0a]'>
        ...
        {repo.projectType === 'monorepo' && repo.workspace && (
          <section>
            <h2 className='text-muted-foreground mb-3 text-sm font-medium'>Packages</h2>
        ...
        {packageJson && !packageJsonError && (
          <section>
            <button
              className='text-muted-foreground hover:text-foreground mb-3 flex w-full items-center gap-2 text-sm font-medium'
