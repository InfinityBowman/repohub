import { Play, Square, RotateCcw, Folder, GitBranch, Github } from 'lucide-react';
...
export function RepositoryCard({ repo }: { repo: Repository }) {
  ...
  return (
    <Card className='hover:border-muted-foreground/30 gap-0 py-0 transition-colors'>
      <div
        ...
        <div className='flex items-center gap-3 overflow-hidden'>
          ...
          <div className='min-w-0'>
            <div className='flex items-center gap-2'>
              <h3 className='text-card-foreground truncate text-sm font-medium'>{displayName}</h3>
