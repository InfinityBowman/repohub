...
import { FolderGit2, Network, Settings, GitPullRequest, Search, Package, Bot } from 'lucide-react';
  ...
  return (
    <aside className='border-border bg-sidebar-background flex h-full w-56 flex-col border-r pt-12'>
      <div className='px-4 pb-4'>
        <h1
          className={`text-lg font-semibold ${isPalenight ? 'text-[#C792EA]' : 'text-foreground'}`}
        >
          RepoHub
        </h1>
      </div>
